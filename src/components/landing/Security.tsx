...
export function Security() {
  ...
  return (
    <section className="relative py-20 md:py-28 bg-slate-800 overflow-hidden" id="security">
      {/* Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-800 via-emerald-900/15 to-slate-900" />
      </div>
